...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graph_widget = QtWidgets.QWidget(self.splitter)
        ...
        self.graph_widget.setMinimumSize(QtCore.QSize(250, 250))
        ...
        self.gridLayout_2.addWidget(self.listView_2, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_2), _translate("MainWindow", "LOG"))
